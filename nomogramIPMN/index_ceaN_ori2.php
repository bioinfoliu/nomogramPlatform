...
function calc() {
	...
	var malix = [
		-3.266789,
		[ "Age", 0.017509, [20,100], 0.017509*20, 0.017509*100, null ],
		[ "Gender", ["Male", "Female"], null, {"Male":-.199866, "Female":0} ],
		[ "Main duct size", 0.201230, [0,20], 0.201230*0, 0.201230*20, null ],
		[ "Cyst size", 0.018977, [0,100], 0.018977*0, 0.018977*100, null ],
		[ "Mural nodule", ["No", "Yes"], null, {"No":0, "Yes":.857989} ],
		[ "Location", ["Body/Tail", "Head", "Diffuse"], null, {"Body/Tail":-0.328433, "Head":0, "Diffuse":0.376753} ],	];
	...
	d3nomogram("#malinomo", obs1, malix, Math.log(maliprob/(1-maliprob)), 900);	
}
$(function() {
	$("button").button();
});
